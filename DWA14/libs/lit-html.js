...
lt?.(X, it), (T.litHtmlVersions ??= []).push("3.1.4");
const at = (t, s, i) => {
...
const Wt = Ut(Bt),
  ...
  Ft = Ut(
    class extends Vt {
      ...
      update(t, [s]) {
        const i = bt(this.bt) ? qt(this.bt) : null,
          e = bt(s) ? qt(s) : null;
  ...
  Yt = Ut(
    class extends Vt {
      ...
      update(t, [s, i]) {
        if (Array.isArray(s)) {
          if (
            Array.isArray(this._t) &&
            this._t.length === s.length &&
            s.every((t, s) => t === this._t[s])
          )
            return F;
        } else if (this._t === s) return F;
        return (
          (this._t = Array.isArray(s) ? Array.from(s) : s), this.render(s, i)
        );
      }
    }
  ),
  ...
  hs = Ut(
    class extends Ht {
      ...
      update(t, [s]) {
        const i = s !== this.ct;
        return (
          i && void 0 !== this.ct && this.St(void 0),
          (i || this.$t !== this.Tt) &&
            ((this.ct = s),
